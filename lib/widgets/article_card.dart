...
class ArticleCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final displayTitle = locale != null 
        ? article.getLocalizedTitle(locale!)
        : article.title;
    final displaySummary = locale != null
        ? article.getLocalizedSummary(locale!)
        : article.summary;
    ...
    return Card(
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: compact ? _buildCompactLayout(
            context, theme, textScale, displayTitle, displaySummary,
            categoryColor, category, isSmallScreen,
          ) : _buildFullLayout(
            context, theme, textScale, displayTitle, displaySummary,
            categoryColor, category, isSmallScreen,
          ),
      ...
      children: [
        ...
        Text(
          ...
          style: GoogleFonts.notoSerifSinhala(
            fontSize: ResponsiveUtils.getResponsiveFontSize(context, 18) * textScale,
            fontWeight: FontWeight.bold,
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: theme.textTheme.labelSmall?.copyWith(
                  color: theme.colorScheme.onSurface.withOpacity(0.6),
                  fontSize: ResponsiveUtils.getResponsiveFontSize(context, 11) * textScale,
                ),
              ),
            ],
          ),
