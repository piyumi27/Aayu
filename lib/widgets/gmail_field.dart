...
class _GmailFieldState extends State<GmailField> {
  ...
  String get _placeholder {
    switch (_selectedLanguage) {
      case 'si': return 'amalka.r';
      case 'ta': return 'amalka.r';
      default: return 'yourname';
    }
  }

  String get _labelText {
    switch (_selectedLanguage) {
      case 'si': return 'Gmail ලිපිනය';
      case 'ta': return 'Gmail முகவரி';
      default: return 'Gmail Address';
    }
  }
  ...
  String get _helperText {
    ...
    switch (_selectedLanguage) {
      case 'si': return 'අකුරු, සංඛ්‍යා, තිත්, යටි ඉර, ප්ලස් හෝ හයිෆන් භාවිතා කරන්න';
      case 'ta': return 'எழுத்துகள், எண்கள், புள்ளிகள், அடிக்கோடுகள், பிளஸ் அல்லது ஹைபன்களைப் பயன்படுத்தவும்';
      default: return 'Use letters, numbers, dots, underscores, plus or hyphens';
    }
  }
