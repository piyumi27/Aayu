...
class ValidationUtils {
  ...
  static String getPhoneErrorMessage(String input, String language) {
    ...
    if (normalized.isEmpty) {
      switch (language) {
        case 'si': return 'දුරකථන අංකය ඇතුළත් කරන්න';
        case 'ta': return 'தொலைபேசி எண்ணை உள்ளிடவும்';
    ...
    if (normalized.length != 9) {
      switch (language) {
        case 'si': return '9 ඉලක්කම් ඇතුළත් කරන්න';
        case 'ta': return '9 இலக்கங்களை உள்ளிடவும்';
        default: return 'Enter 9 digits';
      }
    }
    
    if (!normalized.startsWith('7')) {
      switch (language) {
        case 'si': return '7 සමඟ ආරම්භ වන අංකයක් ඇතුළත් කරන්න';
        case 'ta': return '7 ஆல் தொடங்கும் எண்ணை உள்ளிடவும்';
        default: return 'Number must start with 7';
      }
    }
  ...
  static String getGmailErrorMessage(String localPart, String language) {
    if (localPart.isEmpty) {
      switch (language) {
        case 'si': return 'ඊමේල් ඇතුළත් කරන්න';
        case 'ta': return 'மின்னஞ்சலை உள்ளிடவும்';
        default: return 'Enter email';
      }
    }
    
    if (!validateGmailLocalPart(localPart)) {
      switch (language) {
        case 'si': return 'වලංගු ඊමේල් ඇතුළත් කරන්න (උදා: amalka.r)';
        case 'ta': return 'சரியான மின்னஞ்சலை உள்ளிடவும் (உதா: amalka.r)';
        default: return 'Use letters, numbers, dots, underscores, plus or hyphens. Example: amalka.r';
      }
    }
  ...
  String getDisplayText(String language) {
    switch (this) {
      case PasswordStrength.weak:
        switch (language) {
          case 'si': return 'දුර්වල';
          case 'ta': return 'பலவீனமான';
          default: return 'Weak';
        }
      case PasswordStrength.medium:
        switch (language) {
          case 'si': return 'මධ්‍යම';
          case 'ta': return 'நடுத்தர';
          default: return 'Medium';
        }
      case PasswordStrength.strong:
        switch (language) {
          case 'si': return 'ශක්තිමත්';
          case 'ta': return 'வலுவான';
